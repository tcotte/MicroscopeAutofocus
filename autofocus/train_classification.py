...
train_dataset = ClassificationDataset(images_list=X_train_images, transform=train_transform)
test_dataset = ClassificationDataset(images_list=X_test_images, transform=test_transform)
