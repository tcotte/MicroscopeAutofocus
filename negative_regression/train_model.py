...
X_train, X_test, y_train, y_test = train_test_split(df.X.values, df.y.values, test_size=0.33, random_state=42, shuffle=True)
...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), "model_poly.pt")
    plt.plot(history)
    plt.show()